if (!customElements.get('product-form')) {
    customElements.define('product-form', class ProductForm extends HTMLElement {
      constructor() {
        ...
        this.addOns = this.form.querySelector('[name=add-ons]');
      ...
      onSubmitHandler(evt) {
        ...
        config.body = formData;
          ...
          const data = this.addOns.value.split(", ");
          formData = {
            items: [],
          };
          data.forEach(variant => {
            let obj = {};
            obj["id"] = parseInt(variant);
            obj["quantity"] = 1;
        ...
        fetch(`${routes.cart_add_url}${this.addOns? ".js":""}`, config)
